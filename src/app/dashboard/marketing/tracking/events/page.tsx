    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Define, manage, and monitor custom analytics events across GA4, Google Ads, and Meta Pixel</p>
        </div>
