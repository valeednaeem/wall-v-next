...
const PERMISSION_GROUPS = [
  ...
  { label: "Projects", permissions: [PERMISSIONS.PROJECTS_VIEW, PERMISSIONS.PROJECTS_CREATE, PERMISSIONS.PROJECTS_EDIT, PERMISSIONS.PROJECTS_DELETE, PERMISSIONS.PROJECTS_ASSIGN] },
  { label: "Tasks", permissions: [PERMISSIONS.TASKS_VIEW, PERMISSIONS.TASKS_CREATE, PERMISSIONS.TASKS_EDIT, PERMISSIONS.TASKS_ASSIGN] },
  ...
  { label: "Skills", permissions: [PERMISSIONS.SKILLS_VIEW, PERMISSIONS.SKILLS_CREATE, PERMISSIONS.SKILLS_EDIT, PERMISSIONS.SKILLS_DELETE, PERMISSIONS.SKILLS_EXECUTE, PERMISSIONS.SKILLS_MANAGE] },
  { label: "Tools", permissions: [PERMISSIONS.TOOLS_VIEW, PERMISSIONS.TOOLS_CREATE, PERMISSIONS.TOOLS_EDIT, PERMISSIONS.TOOLS_DELETE, PERMISSIONS.TOOLS_EXECUTE] },
  { label: "Workflows", permissions: [PERMISSIONS.WORKFLOWS_VIEW, PERMISSIONS.WORKFLOWS_CREATE, PERMISSIONS.WORKFLOWS_EDIT, PERMISSIONS.WORKFLOWS_DELETE, PERMISSIONS.WORKFLOWS_EXECUTE] },
  { label: "Finance", permissions: [PERMISSIONS.FINANCE_VIEW, PERMISSIONS.FINANCE_READ, PERMISSIONS.FINANCE_EDIT, PERMISSIONS.FINANCE_CREATE_INVOICE, PERMISSIONS.FINANCE_CREATE_QUOTATION, PERMISSIONS.FINANCE_PROCESS_PAYMENT, PERMISSIONS.FINANCE_REFUND, PERMISSIONS.FINANCE_RECONCILE] },
  { label: "Communications", permissions: [PERMISSIONS.COMMUNICATIONS_PREPARE, PERMISSIONS.COMMUNICATIONS_SEND] },
  { label: "Settings", permissions: [PERMISSIONS.SETTINGS_VIEW, PERMISSIONS.SETTINGS_MANAGE] },
  { label: "Deployment", permissions: [PERMISSIONS.DEPLOYMENT_MANAGE] },
];
