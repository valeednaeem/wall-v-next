...
1. Executive Summary
2. Key Findings
3. Data Visualization (describe charts)
4. Recommendations
5. Next Steps
...
2. **Delay** - Time between emails
3. **Content** - Email body and subject
4. **Conditions** - If/then branching
5. **Goal** - What success looks like
